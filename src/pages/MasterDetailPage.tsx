  ...
  if (!master) {
    return (
      <div className="min-h-screen bg-masonic-dark flex flex-col items-center justify-center p-6 text-center">
        ...
        <button onClick={() => navigate('/galeria-honra')} className="text-masonic-gold underline uppercase tracking-widest text-sm">Voltar à Galeria</button>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4 space-y-6">
              <motion.div 
                ...
                className="bg-masonic-blue rounded-[2rem] p-8 border border-masonic-gold/10 text-center relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 p-6 opacity-10">
                   <User className="w-24 h-24 text-masonic-gold" />
                </div>
                <div className="w-40 h-56 mx-auto rounded-2xl border-4 border-masonic-gold/20 mb-6 flex items-center justify-center bg-white/5 relative overflow-hidden">
                  {master.photo || master.image ? (
                    <img src={master.photo || master.image} alt={master.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                  ) : (
                    <User className="w-16 h-16 text-masonic-gold/30" />
                  )}
                </div>
                <h1 className="font-cinzel text-2xl font-bold text-white mb-2 uppercase tracking-tight leading-tight">{master.name}</h1>
                <p className="text-masonic-gold font-bold uppercase tracking-[0.4em] text-xs mb-4">{master.role}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                 {[
                   ...
                   <div key={i} className="bg-masonic-blue p-6 rounded-3xl border border-white/5 text-center">
                     <stat.icon className="w-5 h-5 text-masonic-gold mx-auto mb-2" />
            ...
            <div className="lg:col-span-8 space-y-12">
               ...
               >
                 <div className="flex items-center gap-3 mb-2">
                    <GraduationCap className="text-masonic-gold w-6 h-6" />
                    <h2 className="text-masonic-gold font-cinzel text-2xl uppercase tracking-widest font-bold">Biografia Maçônica</h2>
                 </div>
                 <div className="p-8 bg-masonic-blue border border-white/5 rounded-[2rem]">
                   <p className="text-white/80 leading-relaxed text-lg font-playfair italic">
                     "{master.biography}"
                   </p>
                 </div>
               </motion.section>
               ...
               {master.firstLady && master.firstLady.name && master.firstLady.name.trim() !== '' && (
                 <motion.section 
                    ...
                    className="w-full bg-[#0b1d3a]/80 border border-[#c5a059]/10 rounded-[2.5rem] p-10 text-left relative overflow-hidden"
                 >
                    <div className="absolute -right-12 -top-12 opacity-5">
                       <Heart className="w-64 h-64 text-[#c5a059]" />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                       <div className="w-32 h-44 flex-shrink-0 rounded-2xl border-2 border-[#c5a059]/20 overflow-hidden bg-white/5">
                          {master.firstLady.photo ? (
                             ...
                             <div className="w-full h-full flex items-center justify-center text-[#c5a059]/20">
                                <User className="w-12 h-12" />
                             </div>
                          )}
                       </div>
                       <div>
                          <h3 className="font-cinzel text-3xl text-[#f4efe2] font-bold mb-4">{master.firstLady.name}</h3>
                          <p className="text-[#f4efe2]/80 text-lg leading-relaxed font-playfair italic border-l-2 border-[#c5a059]/30 pl-6 py-2">
               ...
               <motion.section
                 ...
                 className="p-12 bg-white/5 rounded-[2.5rem] border border-[#c5a059]/20 relative group"
               >
                  <div className="absolute top-0 left-0 w-24 h-24 border-t-2 border-l-2 border-[#c5a059]/40 rounded-tl-[2.5rem]" />
                  <div className="flex items-center gap-4 mb-8">
                    <Calendar className="text-[#c5a059] w-8 h-8" />
                    <h4 className="text-[#f4efe2] font-cinzel text-3xl font-bold uppercase tracking-tight">Legado Ritualístico</h4>
                  </div>
                  <p className="text-[#f4efe2]/90 text-xl leading-relaxed italic font-playfair">
               ...
               >
                 <div className="p-8 bg-masonic-blue rounded-3xl border border-white/5 hover:border-masonic-gold/30 transition-all group">
                    <BookOpen className="text-masonic-gold mb-4 group-hover:scale-110 transition-transform" />
                 ...
                 <div className="p-8 bg-masonic-blue rounded-3xl border border-white/5 hover:border-masonic-gold/30 transition-all group">
                    <Activity className="text-masonic-gold mb-4 group-hover:scale-110 transition-transform" />
