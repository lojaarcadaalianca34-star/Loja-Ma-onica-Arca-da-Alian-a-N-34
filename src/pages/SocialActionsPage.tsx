  ...
  return (
    <div className="min-h-screen bg-aged-beige overflow-x-hidden">
      ...
      <main className="pt-20">
        ...
        <section className="relative py-16 md:py-24 overflow-hidden border-b border-[#c5a059]/10">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10 text-center">
            ...
            >
              ...
              <span className="text-[9px] md:text-[10px] font-sans font-bold uppercase tracking-[0.3em] text-[#c5a059]">Filantropia e Impacto Social</span>
            </motion.div>
            ...
            <motion.p
              ...
              className="max-w-3xl mx-auto text-[#0b1d3a]/80 font-sans text-base md:text-lg leading-relaxed text-center px-2"
            >
        ...
        {/* Stats Grid - CORRIGIDO O ESPAÇAMENTO PARA CELULAR */}
        ...
        {/* Detailed Initiatives - CORRIGIDO PREENCHIMENTO DOS QUADRADOS */}
        <section className="py-16 md:py-24 bg-aged-beige">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-12 md:mb-16">
              ...
              <p className="max-w-md text-[#0b1d3a]/60 text-xs md:text-sm italic border-l border-[#c5a059]/30 pl-4 md:pl-6">
              ...
              {initiatives.map((item, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[#0b1d3a]/80 leading-relaxed font-sans text-xs md:text-sm text-justify">
                      {item.description}
                    </p>
                  </div>

                  <div className="pt-4 border-t border-[#0b1d3a]/10 mt-auto">
                    <div className="flex items-center gap-2 text-[#c5a059]/60 text-[8px] md:text-[9px] uppercase tracking-widest font-black">
        ...
        {/* History of Actions */}
        <section className="py-16 md:py-24 bg-[#c5a059]/10 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="flex items-center gap-3 text-[#c5a059] mb-4 md:mb-6 uppercase tracking-[0.4em] text-[9px] md:text-[10px] font-bold">
                  <History className="w-4 h-4" />
                  Trajetória
                </div>
                <h2 className="font-serif text-2xl md:text-5xl font-bold text-[#0b1d3a] mb-6 md:mb-8 uppercase tracking-widest">
                  O Histórico de <span className="gold-text">Fazer o Bem</span>
                </h2>
                <div className="space-y-4 md:space-y-6 text-[#0b1d3a]/80 font-sans text-sm md:text-base leading-relaxed text-justify">
                  <p>
              ...
              >
                <div className="aspect-square rounded-[2rem] md:rounded-[3rem] overflow-hidden border border-gold-500/20 shadow-2xl skew-y-1 md:skew-y-3">
                  <img 
                ...
                <div className="absolute -bottom-6 -left-4 md:-bottom-10 md:-left-10 w-36 h-36 md:w-48 md:h-48 bg-[#c5a059]/10 backdrop-blur-xl border border-white/20 rounded-full flex flex-col items-center justify-center text-center p-4 md:p-6 -rotate-12 shadow-xl">
                  <span className="text-2xl md:text-3xl font-serif font-black text-[#c5a059]">2009</span>
                  <span className="text-[7px] md:text-[8px] uppercase tracking-widest text-[#0b1d3a]/60 font-bold">Legado Iniciado</span>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-aged-beige">
          <div className="max-w-7xl mx-auto px-4 md:px-6 text-center mb-12">
            <div className="flex justify-center items-center gap-3 text-[#c5a059] mb-4 md:mb-6 uppercase tracking-[0.4em] text-[9px] md:text-[10px] font-bold">
              <Images className="w-4 h-4" />
              Recortes de Luz
            </div>
            <h2 className="font-serif text-2xl md:text-5xl font-bold text-[#0b1d3a] uppercase tracking-wider mb-4 md:mb-6">Galeria de <span className="gold-text">Obras Sociais</span></h2>
            <p className="max-w-2xl mx-auto text-[#0b1d3a]/60 font-sans text-sm">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {[
              ...
              <motion.div
                ...
                className="aspect-square rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 group relative"
              >
                ...
                <div className="absolute inset-0 bg-gold-500/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white">
        ...
        <section className="py-16 md:py-24 bg-[#c5a059]/5 border-y border-[#c5a059]/10">
          <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
            <Quote className="w-10 h-10 md:w-12 md:h-12 text-[#c5a059]/20 mx-auto mb-6 md:mb-8" />
            <h2 className="font-serif text-xl md:text-3xl text-[#0b1d3a]/80 italic leading-relaxed mb-6 md:mb-8">
            ...
            <div className="w-12 h-0.5 bg-[#c5a059]/30 mx-auto mb-4" />
            <span className="uppercase tracking-[0.4em] text-[#c5a059] text-[9px] md:text-[10px] font-black">Reflexão Maçônica</span>
          </div>
        </section>

        {/* CTA Section - CORRIGIDO PREENCHIMENTO INTERNO MOBILE */}
        <section className="py-16 md:py-24 bg-aged-beige">
          <div className="max-w-5xl mx-auto px-4 md:px-6">
            <div className="relative p-6 sm:p-10 md:p-16 rounded-[2rem] md:rounded-[4rem] bg-[#0b1d3a] overflow-hidden text-center shadow-2xl">
              ...
              <div className="relative z-10">
                <h2 className="font-serif text-2xl md:text-5xl font-bold text-[#c5a059] mb-4 md:mb-6 uppercase tracking-wider">Como Você Pode <span className="text-white">Ajudar?</span></h2>
                <p className="max-w-2xl mx-auto text-white/80 font-sans text-sm md:text-lg mb-8 md:mb-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
                  <button className="w-full sm:w-auto px-8 py-3.5 bg-[#c5a059] text-[#0b1d3a] font-black uppercase tracking-[0.2em] text-[9px] md:text-[10px] rounded-full hover:scale-105 transition-all shadow-2xl">
                    Seja um Parceiro
                  </button>
                  <button className="w-full sm:w-auto px-8 py-3.5 bg-transparent border-2 border-[#c5a059] text-[#c5a059] font-black uppercase tracking-[0.2em] text-[9px] md:text-[10px] rounded-full hover:bg-[#c5a059] hover:text-[#0b1d3a] transition-all">
